        ...
        <MDBCard className='m-5' style={{ width: '100%', maxWidth: '600px', backgroundColor: 'rgba(255, 255, 255, 0.8)', borderRadius: '15px', padding: '20px' }}>
          <MDBCardBody className='px-5'>
            ...
            <div className="mb-4">
              ...
              <MDBInput wrapperClass='mb-4' size='lg' id='form1' type='text' placeholder="Your Name"/>
            </div>
            <div className="mb-4">
              <label htmlFor="form2" className="form-label" style={{ fontSize: '1.5rem' }}>Your Email</label>
              <MDBInput wrapperClass='mb-4' size='lg' id='form2' type='email' placeholder="Your Email"/>
            </div>
            <div className="mb-4">
              <label htmlFor="form3" className="form-label" style={{ fontSize: '1.5rem' }}>Password</label>
              <MDBInput wrapperClass='mb-4' size='lg' id='form3' type='password' placeholder="Password"/>
            </div>
            <div className="mb-4">
              <label htmlFor="form4" className="form-label" style={{ fontSize: '1.5rem' }}>Repeat your password</label>
              <MDBInput wrapperClass='mb-4' size='lg' id='form4' type='password' placeholder="Repeat your password"/>
            </div>
